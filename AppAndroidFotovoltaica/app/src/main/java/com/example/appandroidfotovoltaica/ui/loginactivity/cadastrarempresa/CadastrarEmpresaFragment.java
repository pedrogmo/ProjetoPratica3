package com.example.appandroidfotovoltaica.ui.loginactivity.cadastrarempresa;
                ...
                StringRequest postRequest = new StringRequest(
                        ...
                        new Response.Listener<String>()
                        {
                            ...
                            public void onResponse(String response) {
                                ...
                                fragmentTransaction.replace(R.id.fragment_cadastrarempresa, new LoginEmpresaFragment());
